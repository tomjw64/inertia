...
pub const SAMPLE_POSITIONS: &[(&str, &str, usize)] = &[
  ...
  ("shuffle_x", "APwf-A_wB-ADwAGAAAAAAAAAAAAAgADAAeAD8Af4D_wf_B_4D_AH4APAAYAAAAAAAAAAAACAAMAB4APwB_gP_B9kAwRT4Q", 70),
  ("fortress", "AAAAAAAAAAAAAAAAAAAAAAAAAAQIBAgUChQKNAs0CzQLAAAAAAAAAAAAAgACAAoACAAKAAIAAgAAAAAAAAAAAAAAAQ8O5w", 40)
];
